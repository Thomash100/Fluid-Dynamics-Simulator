...
Unter `samples/FDS.WindowsApp` liegt eine kleine WinForms-Test-App für den Referenzsolver. Sie dient nur als konfigurierbares Test-Harness, ist keine produktive Oberfläche und verwendet derzeit deutsche UI-Texte. Die App enthält Presets, strukturierte Ergebnis-Tabs, Tabellen für Strang-Volumenströme, Druckresiduen und Iterationen sowie weiterhin eine Textausgabe für Smoke-Tests und Debugging.
